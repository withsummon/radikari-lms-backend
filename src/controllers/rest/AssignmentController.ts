...
export async function update(c: Context): Promise<TypedResponse> {
    ...
    const serviceResponse = await AssignmentService.update(id, data, tenantId, user.id)
...
export async function deleteById(c: Context): Promise<TypedResponse> {
    ...
    const serviceResponse = await AssignmentService.deleteById(id, tenantId, user.id)
