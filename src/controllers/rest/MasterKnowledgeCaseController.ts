...
export async function create(c:Context): Promise<TypedResponse> {
    ...
    return response_created(c, serviceResponse.data, "Successfully created new MasterKnowledgeCase!");
}
...
export async function getAll(c:Context): Promise<TypedResponse> {
    ...
    return response_success(c, serviceResponse.data, "Successfully fetched all MasterKnowledgeCase!")
}
...
export async function getById(c:Context): Promise<TypedResponse> {
    ...
    return response_success(c, serviceResponse.data, "Successfully fetched MasterKnowledgeCase by id!")
}
...
export async function update(c:Context): Promise<TypedResponse> {
    ...
    return response_success(c, serviceResponse.data, "Successfully updated MasterKnowledgeCase!")
}
...
export async function deleteById(c:Context): Promise<TypedResponse> {
    ...
    return response_success(c, serviceResponse.data, "Successfully deleted MasterKnowledgeCase!")
}
