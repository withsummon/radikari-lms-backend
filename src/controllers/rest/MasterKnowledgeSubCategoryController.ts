...
export async function create(c: Context): Promise<TypedResponse> {
	...
	return response_created(
		...
		"Successfully created new MasterKnowledgeSubCategory!",
	)
}
...
export async function getAll(c: Context): Promise<TypedResponse> {
	...
	return response_success(
		c,
		serviceResponse.data,
		"Successfully fetched all MasterKnowledgeSubCategory!",
	)
}
...
export async function getById(c: Context): Promise<TypedResponse> {
	...
	return response_success(
		c,
		serviceResponse.data,
		"Successfully fetched MasterKnowledgeSubCategory by id!",
	)
}
...
export async function update(c: Context): Promise<TypedResponse> {
	...
	const serviceResponse = await MasterKnowledgeSubCategoryService.update(
		id,
		data,
	)
	...
	return response_success(
		c,
		serviceResponse.data,
		"Successfully updated MasterKnowledgeSubCategory!",
	)
}
...
export async function deleteById(c: Context): Promise<TypedResponse> {
	...
	return response_success(
		c,
		serviceResponse.data,
		"Successfully deleted MasterKnowledgeSubCategory!",
	)
}
