...
import { AiChatRoomMessage, AiChatRoomMessageKnowledge } from "../../generated/prisma/client"
...
export async function buildRequestBody(
    ...
    return {
        chatHistory: chatHistory.map((data) => ({
            ...
            knowledgeIds: data.aiChatRoomMessageKnowledge.map((knowledge) => knowledge.knowledgeId),
        })),
        // chatHistory: [],
