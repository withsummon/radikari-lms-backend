...
import { AiChatRoomMessageSchema, AiChatRoomSchema } from "./schema/AiChatRoomSchema"
...
export async function validateAiChatRoomSchema(c: Context, next: Next) {
    ...
    let invalidFields: Helpers.ErrorStructure[] = Helpers.validateSchema(AiChatRoomSchema, data)
