    ...
    try {
      ...
      for (let i = 0; i < records.length; i++) {
        ...
        if (question && question.trim()) {
          ...
          console.log(`🤖 Processing question ${i + 1}/${records.length}: ${question.substring(0, 50)}...`);
      ...
      const outputData = [
        ['No', 'Judul Case', 'Sampel 3 Question', 'Jawaban AI', 'Benar/Salah', 'Jawaban yang Seharusnya', 'Sources']
      ];
